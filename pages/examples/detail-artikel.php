        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Detail Data</h6>
      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            ?>
              <form action="update-data-artikel" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
              ...
              <form action="update-gambar-konsultan.php" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
                <input type="hidden" name="id_konsultan" value="<?php echo $id; ?>"></input>
                    <hr class="my-4" />
                    <h6 class="heading-small text-muted mb-4">Gambar Artikel</h6>
                    <?php
                        $Select = mysqli_query($koneksi, "SELECT * FROM gambar_artikel where id_artikel = '$id'");
                        while($GetDataGam = mysqli_fetch_array($Select)) {
                            echo "$GetDataGam[nama_gambar]
                            <img class='card-img-top' src='../../assets/img/img-artikel/$GetDataGam[nama_gambar]' alt='Image placeholder'>";
                        }
                    ?>
              </form>
            </div>
