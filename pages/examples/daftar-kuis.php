  ...
  <div class="main-content" id="panel">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Daftar Kuis</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="dashboard"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item">Daftar Kuis</li>
                  <li class="breadcrumb-item active" aria-current="page">Daftar Kuis</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="tambah-data-kuis" class="btn btn-sm btn-default">Tambah Data</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Page content -->
      <div class="card">
        ...
        $Number = 1;
        $GetTable = mysqli_query($koneksi, "SELECT * FROM kuisioner");
        while ($GetData = mysqli_fetch_array($GetTable)) {
            echo "
                <tr>
                    ...
                    <td>
                    <a href='edit-data-kuis?id_kuisioner=$GetData[id_kuisioner]'class='table-action' data-toggle='tooltip' data-original-title='Edit Data'>
                    <i class='fas fa-user-edit'></i>
                    </a>
                    <a href='hapus-data-kuis?id_kuisioner=$GetData[id_kuisioner]'class='table-action table-action-delete' data-toggle='tooltip' data-original-title='Delete Data'>
