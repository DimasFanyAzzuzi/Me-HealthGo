            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="gambar-artikel">Daftar Gambar</a></li>
      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form action="insert-data-gambar-artikel" method="POST" enctype="multipart/form-data" autocomplete="OFF"> 
