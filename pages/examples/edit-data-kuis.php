                ...
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center">
                    ...
                    <div>
                      ...
                      <span class="description">Kuisioner</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card">
            ...
            <?php
              ...
              $SelectData = mysqli_query($koneksi, "SELECT * FROM kuisioner WHERE id_kuisioner = '$id'");
              $GetData = mysqli_fetch_array($SelectData);
            ?>
            <div class="card-body">
              <form action="update-data-kuis" method="POST" enctype="multipart/form-data" autocomplete="OFF">
              <input type="hidden" name="id_kuisioner" value="<?php echo $id; ?>"></input> 
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-email" class="form-control" name="pertanyaan" placeholder="Isi pertanyaan kuisioner" value="<?php echo $GetData['pertanyaan']?>">
                      </div>
                    </div>  
                  </div>
                </div>
